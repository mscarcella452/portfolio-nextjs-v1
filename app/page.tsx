...
export default function Home() {
  return (
    <>
      ...
      <section className='bg-background-light dark:bg-neutral-dark dark:text-neutral flex'>
        <div className='flex-1'>{fullContent}</div>
      </section>
      <section className='bg-background dark:bg-background-dark dark:text-white flex'>
        <div className='flex-1'>{fullContent}</div>
      </section>
    </>
  );
